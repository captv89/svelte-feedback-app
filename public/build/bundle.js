...
var app = (function () {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 17, 2, 414);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$FeedbackStore*/ 4) {
    			$$invalidate(0, average = ($FeedbackStore.reduce((a, { rating }) => a + rating, 0) / $FeedbackStore.length).toFixed(2));
    		}
    	};
